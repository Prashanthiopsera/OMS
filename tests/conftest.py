...
class _TestSessionFactory:
    """Makes async_session_factory() return the shared rollback-isolated session."""
...
def environment_factory():
    from tests.factories import make_environment
...
@pytest.fixture
def user_brand_role_factory():
    from tests.factories import make_user_brand_role

    return make_user_brand_role
